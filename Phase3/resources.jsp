...
<html>
<head>
<title>Bison Maps - Find Resources</title>
    ...
    <td height="252" colspan="5" bordercolor="0"><div align="center">
        <table width="75%" border="1">
          <tr>
            ...
            <td><form name="form1" method="post" action="/ResourceFinder">
                <select name="select">
            ...
            <td><form name="form2" method="post" action="/ResourceFinder">
                <select name="select2">
                  <option value="1">ATM</option>
                  <option value="2">Vending Machines</option>
                  <option value="3">Rest Rooms</option>
                  <option value="4">Public Phones</option>
                  <option value="5">Rest Rooms</option>
                  <option value="6">WiFi Hotspot</option>
                  <option value="7">Security</option>
                  <option value="8">Bus Stops</option>
                  <option value="-999" selected>None</option>
                </select>
              </form></td>
          </tr>
          ...
          <tr>
            ...
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td><form name="form3" method="post" action="http://safe-anchorage-5379.heroku.com/ResourceFinder">
